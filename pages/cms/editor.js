  ...
  const TipePage = dynamic(() => import('@tipe/react-editor').then(mod => mod.EditorPage), { ssr: false })
  const EditorPage = props => <TipePage {...props} />
  ...
  const Page = WithTipePage(EditorPage, {
    client,
    schema,
    customFields,
    mountPath: 'cms',
